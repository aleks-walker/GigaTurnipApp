package kg.kloop.android.gigaturnip.ui.theme
...
@Composable
fun GigaTurnipTheme(content: @Composable () -> Unit) {

    MaterialTheme(colors = ColorPalette, typography = Typography, content = content)
}

@Composable
fun GigaTurnipDialogThemeOverlay(content: @Composable () -> Unit) {
    // GigaTurnip is always dark themed.
